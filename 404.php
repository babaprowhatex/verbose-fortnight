...
if ($title == 'access') {
  $alert = '403';
  $title = '<h2>UH OH! No Access!</h2>';
  $caption = '<p>Access to this resource on the server is denied! 
...
if (empty($title)) {
  $alert = '404';
  $title = '<h2>UH OH! You Are Lost!</h2>';
  $caption = '<p>We think you searching somethink different.  
  How you got here is a mystery. But you can click the button below to go back to the homepage. 
</p>';
}
...
<head>
  <meta charset="UTF-8">
  <title><?php echo $alert ?> - PENTA</title>
  ...
  <main>
    <div class="container">
      <div class="row">
        ...
        <p>We think you searching somethink different.  
  How you got here is a mystery. But you can click the button below to go back to the homepage. 
</p>
        </div>
      </div>
